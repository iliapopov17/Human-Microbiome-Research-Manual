...
```{r}
ggsave("img/microbiome_barplot.png", width = 11, height = 3.5, dpi = 600)
```
...
```{r}
ggsave("img/coverage_quality.png", width = 11, height = 3.5, dpi = 600)
```
...
```{r}
ggsave("img/post-filtration coverage.png", width = 11, height = 3.5, dpi = 600)
```
...
```{r}
ggsave("img/remaining proportion.png", width = 11, height = 3.5, dpi = 600)
```
...
```{r}
ggsave("img/relative abundance of the main microbial organisms.png", width = 8, height = 10, dpi = 600)
```
...
```{r}
ggsave("img/alpha diversity.png", width = 8, height = 8, dpi = 600)
```
...
```{r}
ggsave("img/beta diversity.png", width = 8, height = 8, dpi = 600)
```
...
```{r}
ggsave("img/heatmap with split.png", width = 10, height = 10, dpi = 600)
```
...
```{r}
ggsave("img/mean difference.png", width = 10, height = 10, dpi = 600)
```
...
```{r}
ggsave("img/approximate difference.png", width = 10, height = 10, dpi = 600)
```
...
```{r}
ggsave("img/balance value.png", width = 8, height = 8, dpi = 600)
```
